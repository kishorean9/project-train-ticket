...
package project.pe.source.example;
...
public class ExampleStream extends AbstractAdapterIncludedStream {
  ...
  public SpDataStream declareModel() {
    return DataStreamBuilder.create("project.pe.source.example")
          ...
          .protocol(Protocols.kafka(Config.INSTANCE.getKafkaHost(), Config.INSTANCE.getKafkaPort(), "project.source.jvm"))
          .build();
  }
